...
List<SearchResult> filtrarVehiculos({
  required List<User> lista,
  required String palabraClave,
  required String Function(User) obtenerNombre,
  String Function(User)? obtenerPlaca,
  String Function(User)? obtenerUui,
  String Function(User)? obtenerIdentificacion,
}) {
  List<ExtractedResult<User>> coincidenciasNombres = extractAllSorted(
    query: palabraClave,
    choices: lista,
    cutoff: 70,
  ...
  List<ExtractedResult<User>> coincidenciasPlacas = obtenerPlaca != null
      ? extractAllSorted(
          query: palabraClave,
          choices: lista,
          cutoff: 40,
  ...
  List<ExtractedResult<User>> coincidenciasUui = obtenerUui != null
      ? extractAllSorted(
          query: palabraClave,
          choices: lista,
          cutoff: 40,
  ...
  List<ExtractedResult<User>> coincidenciasIdentificacion =
  ...
  int obtenerScore(List<ExtractedResult<User>> coincidencias, User objeto) {
    try {
